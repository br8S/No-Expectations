...
for(var i=0; i < mix_images.length; i++){
    (function(i){
        ...
        mix_images[i].addEventListener('mouseleave', () => {
            mix_images[i].style.opacity = "0.5";
            console.log
        })
    }(i));
}